...
dmsApp.directive('footerBar',function(){
	...
	return {
		restrict : 'E',
		replace: 'false',
		templateUrl : 'modules/templates/footer/footer.html'
	}
});
...
dmsApp.directive('headerBar',function(){
	...
	return {
		restrict : 'E',
		replace: 'false',
		templateUrl : 'modules/templates/header/header.html'
	}
});
...
dmsApp.directive('menuBar',function(){
	...
	return {
		restrict : 'E',
		replace: 'false',
		templateUrl : 'modules/templates/menu/menu.html'
	}
});
...
dmsApp.directive('welcomeInfo',function(){
	...
	return {
		restrict : 'E',
		replace: 'false',
		templateUrl : 'modules/templates/info/welcome-info.html'
	}
});
...
dmsApp.directive('customTable',function(){
	...
	return {
		restrict : 'E',
		replace: 'false',
		templateUrl : 'modules/templates/table/custom-table.html'
	}
});
